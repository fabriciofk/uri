...
valor monetário. A seguir, calcule o menor número de notas e moedas possíveis no qual o 
valor pode ser decomposto. As notas consideradas são de 100, 50, 20, 10, 5, 2. 
...
for cedula in cedulas:
    total = int(valor / cedula) 
    valor -= total * cedula
    print ('{} nota(s) de R$ {}.00'.format(total , cedula))
